                  ...
                  <div className='flex max-sm:flex-col gap-2 mt-4'>
                    ...
                    {currentTab === 'Connections' && (
                      <button
                        ...
                        className='w-full p-2 text-sm rounded bg-slate-100 hover:bg-slate-200 text-black active:scale-95 transition cursor-pointer flex items-center gap-2 justify-center'
                      >
